...
if __name__ == '__main__':
    ...
    f1_name = '../../result/synthetic/g/f1_wheel_flatten_g.txt'
    ncr_name = '../../result/synthetic/g/ncr_wheel_flatten_g.txt'
    file_f1 = open(f1_name, 'w')
    file_ncr = open(ncr_name, 'w')
    ct_name = '../../result/synthetic/g/ct_wheel_flatten_g.txt'
    dist_name = '../../result/synthetic/g/dist_wheel_flatten_g.txt'
    ...
    for t_num_i in range(t_num):
        ...
        for i in range(num):
            ...
            print(g, 'f1', wheel_flatten_f1[i], 'ncr', wheel_flatten_ncr[i])
