...
if __name__ == '__main__':
    ...
    f1_name = '../../result/synthetic/g/f1_olh_sample_g.txt'
    ncr_name = '../../result/synthetic/g/ncr_olh_sample_g.txt'
    file_f1 = open(f1_name, 'w')
    file_ncr = open(ncr_name, 'w')
    ct_name = '../../result/synthetic/g/ct_olh_sample_g.txt'
    dist_name = '../../result/synthetic/g/dist_olh_sample_g.txt'
    ...
    for t_num_i in range(t_num):
        ...
        for i in range(num):
            ...
            print(g, 'f1', olh_sample_f1[i], 'ncr', olh_sample_ncr[i])
            print(OLH_sample_Ct)
