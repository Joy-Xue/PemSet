...
if __name__ == '__main__':
    ...
    # f1_name = '../../result/synthetic/g/f1_pckv_ue_g.txt'
    # ncr_name = '../../result/synthetic/g/ncr_pckv_ue_g.txt'
    f1_name = '../../result/synthetic/f1_pckv_ue_g5.txt'
    ncr_name = '../../result/synthetic/ncr_pckv_ue_g5.txt'
    file_f1 = open(f1_name, 'w')
    file_ncr = open(ncr_name, 'w')
    # ct_name = '../../result/synthetic/g/ct_pckv_ue_g.txt'
    # dist_name = '../../result/synthetic/g/dist_pckv_ue_g.txt'
    ct_name = '../../result/synthetic/ct_pckv_ue_g5.txt'
    dist_name = '../../result/synthetic/dist_pckv_ue_g5.txt'
    ...
    for t_num_i in range(t_num):
        ...
        for i in range(num):
            ...
            print(g, 'f1', pckv_ue_f1[i], 'ncr', pckv_ue_ncr[i])
            print(pckv_ue_Ct)
            print(pckv_ue_dist)
