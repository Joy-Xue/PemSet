...
if __name__ == '__main__':
    ...
    f1_name = '../../result/real_url/g/f1_olh_sample_g.txt'
    ncr_name = '../../result/real_url/g/ncr_olh_sample_g.txt'
    file_f1 = open(f1_name, 'w')
    file_ncr = open(ncr_name, 'w')
    ct_name = '../../result/real_url/g/ct_olh_sample_g.txt'
    dist_name = '../../result/real_url/g/dist_olh_sample_g.txt'
