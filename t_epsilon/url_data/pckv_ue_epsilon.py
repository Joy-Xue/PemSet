...
if __name__ == '__main__':
    ...
    f1_name = '../../result/real_url/epsilon/f1_pckv_ue_g156_c5_epsilon.txt'
    ncr_name = '../../result/real_url/epsilon/ncr_pckv_ue_g156_c5_epsilon.txt'
    file_f1 = open(f1_name, 'w')
    file_ncr = open(ncr_name, 'w')
    ct_name = '../../result/real_url/epsilon/ct_pckv_ue_g156_c5_epsilon.txt'
    dist_name = '../../result/real_url/epsilon/dist_pckv_ue_g156_c5_epsilon.txt'
    ...
    print(Real_k_dist)
    prefix_X, si = data_to_prefix(X, N, g, c, m, k)
    f1_name = '../../result/real_url/epsilon/f1_pckv_ue_g156_c10_epsilon.txt'
    ncr_name = '../../result/real_url/epsilon/ncr_pckv_ue_g156_c10_epsilon.txt'
    file_f1 = open(f1_name, 'w')
    file_ncr = open(ncr_name, 'w')
    ct_name = '../../result/real_url/epsilon/ct_pckv_ue_g156_c10_epsilon.txt'
    dist_name = '../../result/real_url/epsilon/dist_pckv_ue_g156_c10_epsilon.txt'
    file_ct = open(ct_name, 'w')
    file_dist = open(dist_name, 'w')
    t_num = 10
    for t_num_i in range(t_num):
