...
if __name__ == '__main__':
    ...
    file_name = '../../data/url_data/160_5.txt'
    X, Real_k_dist, Real_k_data, N, c = read_data(file_name, k)
    print(Real_k_data)
    print(Real_k_dist)
    prefix_X, si = data_to_prefix(X, N, g, c, m, k)
    f1_name = '../../result/real_url/epsilon/f1_wheel_flatten_g16_c5_epsilon.txt'
    ncr_name = '../../result/real_url/epsilon/ncr_wheel_flatten_g16_c5_epsilon.txt'
    file_f1 = open(f1_name, 'a')
    file_ncr = open(ncr_name, 'a')
    ct_name = '../../result/real_url/epsilon/ct_wheel_flatten_g16_c5_epsilon.txt'
    dist_name = '../../result/real_url/epsilon/dist_wheel_flatten_g16_c5_epsilon.txt'
