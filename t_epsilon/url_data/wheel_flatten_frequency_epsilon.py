...
if __name__ == '__main__':
    ...
    f1_name = '../../result/real_url/epsilon/f1_wheel_flatten_frequency_g16_c10_epsilon.txt'
    ncr_name = '../../result/real_url/epsilon/ncr_wheel_flatten_frequency_g16_c10_epsilon.txt'
