...
if __name__ == '__main__':
    ...
    f1_name = '../../result/real_url/epsilon/f1_olh_sample_g16_c5_epsilon.txt'
    ncr_name = '../../result/real_url/epsilon/ncr_olh_sample_g16_c5_epsilon.txt'
    file_f1 = open(f1_name, 'a')
    file_ncr = open(ncr_name, 'a')
    ct_name = '../../result/real_url/epsilon/ct_olh_sample_g16_c5_epsilon.txt'
    dist_name = '../../result/real_url/epsilon/dist_olh_sample_g16_c5_epsilon.txt'
