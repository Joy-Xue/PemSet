...
if __name__ == '__main__':
    ...
    f1_name = '../../result/synthetic/epsilon/f1_olh_g6_c5_epsilon.txt'
    ncr_name = '../../result/synthetic/epsilon/ncr_olh_g6_c5_epsilon.txt'
    file_f1 = open(f1_name, 'a')
    file_ncr = open(ncr_name, 'a')
    ct_name = '../../result/synthetic/epsilon/ct_olh_g6_c5_epsilon.txt'
    dist_name = '../../result/synthetic/epsilon/dist_olh_g6_c5_epsilon.txt'
    ...
    for t_num_i in range(t_num):
        ...
        for i in range(num):
            ...
            print(i, 'f1', olh_f1[i], 'ncr', olh_ncr[i])
            print(OLH_Ct)
            print(OLH_dist)
