...
if __name__ == '__main__':
    ...
    # file_name = 'D:/experiment/pythonProject/PEM_Set_Valued_Data/data/64_10.txt'
    file_name = '../../data/synthetic_data/64_10.txt'
    f1_name = '../../result/synthetic/f1_wheel_g6_k.txt'
    ncr_name = '../../result/synthetic/ncr_wheel_g6_k.txt'
    ...
    for t_num_i in range(t_num):
        ...
        for i in range(num):
            ...
            # print(i, 'f1', wheel_f1[i])
            # print(i, 'ncr', wheel_ncr[i])
            print(k, 'f1', wheel_f1[i], 'ncr', wheel_ncr[i])
            file_f1.write(str(wheel_f1[i]) + ', ')
            file_ncr.write(str(wheel_ncr[i]) + ', ')
        file_ncr.write('\n')
        file_f1.write('\n')
        print('wheel', t_num_i)
        print(wheel_f1)
