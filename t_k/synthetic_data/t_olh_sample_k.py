...
if __name__ == '__main__':
    ...
    f1_name = '../../result/synthetic/k/f1_olh_sample_g6_k.txt'
    ncr_name = '../../result/synthetic/k/ncr_olh_sample_g6_k.txt'
    file_f1 = open(f1_name, 'a')
    file_ncr = open(ncr_name, 'a')
    ct_name = '../../result/synthetic/k/ct_olh_sample_g6_k.txt'
    dist_name = '../../result/synthetic/k/dist_olh_sample_g6_k.txt'
