...
if __name__ == '__main__':
    ...
    # f1_name = '../../result/synthetic/k/f1_pckv_ue_g60_k.txt'
    # ncr_name = '../../result/synthetic/k/ncr_pckv_ue_g60_k.txt'
    f1_name = '../../result/synthetic/f1_pckv_ue_g60_k.txt'
    ncr_name = '../../result/synthetic/ncr_pckv_ue_g60_k.txt'
    file_f1 = open(f1_name, 'a')
    file_ncr = open(ncr_name, 'a')
    # ct_name = '../../result/synthetic/k/ct_pckv_ue_g60_k.txt'
    # dist_name = '../../result/synthetic/k/dist_pckv_ue_g60_k.txt'
    ct_name = '../../result/synthetic/ct_pckv_ue_g60_k.txt'
    dist_name = '../../result/synthetic/dist_pckv_ue_g60_k.txt'
    ...
    for t_num_i in range(t_num):
        ...
        for i in range(num):
            ...
            # print(i, 'f1', pckv_ue_f1[i])
            # print(i, 'ncr', pckv_ue_ncr[i])
            print(k, 'f1', pckv_ue_f1[i], 'ncr', pckv_ue_ncr[i])
            print(pckv_ue_Ct)
            print(pckv_ue_dist)
