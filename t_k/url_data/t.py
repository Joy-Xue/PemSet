...
if __name__ == '__main__':
    ...
    # f1_name = '../../result/real_url/k/f1_pckv_ue_g156_k.txt'
    # ncr_name = '../../result/real_url/k/ncr_pckv_ue_g156_k.txt'
    f1_name = '../../result/real_url/f1_pckv_ue_g156_k.txt'
    ncr_name = '../../result/real_url/ncr_pckv_ue_g156_k.txt'
    file_f1 = open(f1_name, 'w')
    file_ncr = open(ncr_name, 'w')
    # ct_name = '../../result/real_url/k/ct_pckv_ue_g156_k.txt'
    # dist_name = '../../result/real_url/k/dist_pckv_ue_g156_k.txt'
    ct_name = '../../result/real_url/ct_pckv_ue_g156_k.txt'
    dist_name = '../../result/real_url/dist_pckv_ue_g156_k.txt'
