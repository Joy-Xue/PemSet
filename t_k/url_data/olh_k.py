...
if __name__ == '__main__':
    ...
    f1_name = '../../result/real_url/k/f1_olh_g16_k1.txt'
    ncr_name = '../../result/real_url/k/ncr_olh_g16_k1.txt'
    file_f1 = open(f1_name, 'w')
    file_ncr = open(ncr_name, 'w')
    ct_name = '../../result/real_url/k/ct_olh_g16_k1.txt'
    dist_name = '../../result/real_url/k/dist_olh_g16_k1.txt'
