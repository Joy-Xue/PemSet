...
if __name__ == '__main__':
    ...
    f1_name = '../../result/real_url/k/f1_olh_sample_g16_k.txt'
    ncr_name = '../../result/real_url/k/ncr_olh_sample_g16_k.txt'
    file_f1 = open(f1_name, 'w')
    file_ncr = open(ncr_name, 'w')
    ct_name = '../../result/real_url/k/ct_olh_sample_g16_k.txt'
    dist_name = '../../result/real_url/k/dist_olh_sample_g16_k.txt'
