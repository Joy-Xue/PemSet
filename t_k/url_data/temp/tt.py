...
if __name__ == '__main__':
    ...
    f1_name = '../../result/real_url/k/f1_wheel_flatten_g16_k3.txt'
    ncr_name = '../../result/real_url/k/ncr_wheel_flatten_g16_k3.txt'
    file_f1 = open(f1_name, 'w')
    file_ncr = open(ncr_name, 'w')
    ct_name = '../../result/real_url/k/ct_wheel_flatten_g16_k3.txt'
    dist_name = '../../result/real_url/k/dist_wheel_flatten_g16_k3.txt'
    ...
    # X, Real_k_dist, Real_k_data = generate_data(N, c, k)
    file_name = '../../data/url_data/160_10.txt'
    f1_name = '../../result/real_url/k/f1_wheel_flatten_g16_k4.txt'
    ncr_name = '../../result/real_url/k/ncr_wheel_flatten_g16_k4.txt'
    file_f1 = open(f1_name, 'w')
    file_ncr = open(ncr_name, 'w')
    ct_name = '../../result/real_url/k/ct_wheel_flatten_g16_k4.txt'
    dist_name = '../../result/real_url/k/dist_wheel_flatten_g16_k4.txt'
    file_ct = open(ct_name, 'w')
    file_dist = open(dist_name, 'w')
    t_num = 1
    for t_num_i in range(t_num):
