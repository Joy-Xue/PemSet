...
if __name__ == '__main__':
    ...
    f1_name = '../../result/real_url/k/f1_twheel_flatten_g16_k.txt'
    ncr_name = '../../result/real_url/k/ncr_twheel_flatten_g16_k.txt'
    file_f1 = open(f1_name, 'w')
    file_ncr = open(ncr_name, 'w')
    ct_name = '../../result/real_url/k/ct_twheel_flatten_g16_k.txt'
    dist_name = '../../result/real_url/k/dist_twheel_flatten_g16_k.txt'
