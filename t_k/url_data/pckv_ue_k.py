...
if __name__ == '__main__':
    ...
    f1_name = '../../result/real_url/k/epsilon3/f1_pckv_ue_g156_k.txt'
    ncr_name = '../../result/real_url/k/epsilon3/ncr_pckv_ue_g156_k.txt'
    file_f1 = open(f1_name, 'w')
    file_ncr = open(ncr_name, 'w')
    ct_name = '../../result/real_url/k/epsilon3/ct_pckv_ue_g156_k.txt'
    dist_name = '../../result/real_url/k/epsilon3/dist_pckv_ue_g156_k.txt'
