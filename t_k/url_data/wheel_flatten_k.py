    ...
    if l_s < 33:
        for i in range(1, g + 1):
            ...
            if i == 1:
                ...
                Ct, wheel_dist = construct_C(EstimateDist_wheel_flatten, k, D)
            elif i == g:
                D = construct_D(Ct, k, m, i, g)
                EstimateDist_wheel_flatten = set_wheel(t_X, Ni, c, epsilon, D)
                Ct, wheel_dist = construct_C(EstimateDist_wheel_flatten, k, D)
...
if __name__ == '__main__':
    ...
    f1_name = '../../result/real_url/k/f1_wheel_flatten_g16_k1.txt'
    ncr_name = '../../result/real_url/k/ncr_wheel_flatten_g16_k1.txt'
    file_f1 = open(f1_name, 'w')
    file_ncr = open(ncr_name, 'w')
    ct_name = '../../result/real_url/k/ct_wheel_flatten_g16_k1.txt'
    dist_name = '../../result/real_url/k/dist_wheel_flatten_g16_k1.txt'
    ...
    for t_num_i in range(t_num):
        ...
        for i in range(num):
            ...
            print(k, 'f1', wheel_flatten_f1[i], 'ncr', wheel_flatten_ncr[i])
    ...
    # X, Real_k_dist, Real_k_data = generate_data(N, c, k)
    file_name = '../../data/url_data/160_10.txt'
    f1_name = '../../result/real_url/k/f1_wheel_flatten_g16_k2.txt'
    ncr_name = '../../result/real_url/k/ncr_wheel_flatten_g16_k2.txt'
    file_f1 = open(f1_name, 'w')
    file_ncr = open(ncr_name, 'w')
    ct_name = '../../result/real_url/k/ct_wheel_flatten_g16_k2.txt'
    dist_name = '../../result/real_url/k/dist_wheel_flatten_g16_k2.txt'
    file_ct = open(ct_name, 'w')
    file_dist = open(dist_name, 'w')
    t_num = 1
    for t_num_i in range(t_num):
